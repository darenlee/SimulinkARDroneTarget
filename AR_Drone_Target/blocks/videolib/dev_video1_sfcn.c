/*
 *   dev_video1_sfcn.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        videorabImage1(uint8 y1[1843200])
 *
 *   Simulink version           : 8.7 (R2016a) 10-Feb-2016
 *   C source code generated on : 18-Apr-2016 15:10:16
...
/*
   ...
   def.SFunctionName = 'dev_video1_sfcn';
   def.OutputFcnSpec = 'videorabImage1(uint8 y1[1843200])';
 ...
 */
#define S_FUNCTION_NAME                dev_video1_sfcn
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "videorabImage1", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
