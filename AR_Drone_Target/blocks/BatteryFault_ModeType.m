...
classdef BatteryFault_ModeType < Simulink.IntEnumType
    ...
    methods (Static)
        ...
        function defaultValue = getDefaultValue()
            ...
            defaultValue = BatteryFault_ModeType.None;
        end
        ...
        function desc = getDescription()
            ...
            desc = 'enumeration to track active child state of Free_Flight_Pitch_Test_III/Flight Controller/Supervisory Flight Controller/Fault_Check/BatteryFault_Check';
        end
